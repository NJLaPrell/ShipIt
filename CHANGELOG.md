...
- **First stable 1.0 release** — CLI-first architecture, npm package `@nlaprell/shipit`, release readiness docs (PUBLISHING, TROUBLESHOOTING, CLI_REFERENCE, etc.), trusted publishing (OIDC) support.

### Changed

- **Version** — Bumped to 1.0.0 for production-ready stable release.
