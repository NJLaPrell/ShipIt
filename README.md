...
| -------------------- | ------------------------------------------------ | --------------------------------------------------- | -------------------------- |
| **Release plan**     | `generated/release/plan.md`                      | What ships when — intents ordered by release target | `generate-release-plan.sh` |
| **Roadmap**          | `generated/roadmap/` (now.md, next.md, later.md) | Triage view — now / next / later                    | `generate-roadmap.sh`      |
| **Dependency graph** | `generated/artifacts/dependencies.md`            | Graph of intent dependencies                        | `generate-roadmap.sh`      |
