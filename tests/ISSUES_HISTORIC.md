...
### Run: 2026-02-11T00:06:00Z (root-project)
...
| ---- | --------------------- | ------- | -------- | -------------------------------------------------- |
| 1-1  | Init test project     | ✅ PASS | -        | rm -rf; init-project.sh shipit-test; fixtures used |
| 1-2  | Verify fixture inputs | ✅ PASS | -        | Tech stack, description, high-risk domains match   |
| 1-3  | Verify project dir    | ✅ PASS | -        | ./tests/test-project created                       |
| 1-4  | Verify required files | ✅ PASS | -        | project.json, package.json, tsconfig.json, etc.    |
...
### Run: 2026-02-10T04:02:30Z (test-project)
...
| 13-1       | /drift_check                         | ✅ PASS | -        | \_system/drift/metrics.md                                       |
| 14-1       | /deploy staging                      | ✅ PASS | -        | deploy.sh ran readiness checks                                  |
| 15-1       | Create disposable intent             | ✅ PASS | -        | F-006 Temporary kill intent                                     |
