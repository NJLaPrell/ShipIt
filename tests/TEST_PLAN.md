...
2. Verify:
   ...
   - `generated/roadmap/` directory exists
...
4. Verify:
   ...
   - `generated/roadmap/now.md`, `generated/roadmap/next.md`, `generated/roadmap/later.md` updated (intents with no dependencies in Now; dependent intents in Next/Later)
   - `generated/release/plan.md` exists and contains an ordered list
...
3. Verify:
   ...
   - `generated/roadmap/*.md` refreshes
   - `generated/release/plan.md` refreshes
...
2. Verify:
   - `generated/release/plan.md` contains:
     - Summary with counts
...
2. Verify:
   - `generated/roadmap/now.md`, `generated/roadmap/next.md`, `generated/roadmap/later.md` reflect intent status/dependencies
   - `generated/artifacts/dependencies.md` exists (generated by the roadmap script)
...
3. Verify:
   - `generated/release/plan.md` includes a **Missing Dependencies** section listing `F-999`
...
2. Verify that both:
   - `generated/roadmap/*.md` updates
   - `generated/release/plan.md` updates
...
1. Run:
   - `/drift_check`
2. Verify:
   - `generated/drift/metrics.md` is created or updated
...
4. **Verify documentation:**
   ...
   - `generated/release/plan.md` is accurate
