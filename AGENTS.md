...
| `generated/drift/`             | Entropy monitoring                                |
| `generated/roadmap/`           | Planning views (now, next, later)                 |
| `/behaviors/`                  | Procedures and policies (release, issue tracking) |

`generated/artifacts/SYSTEM_STATE.md` is generated by `scripts/generate-system-state.sh` and read by the Steward.

**Full directory map:** See [architecture/CANON.md](./architecture/CANON.md) Directory Boundaries and [docs/DIRECTORY_STRUCTURE.md](./docs/DIRECTORY_STRUCTURE.md).
